<div id="footer" class="footer">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="section-container">
                        <h4 class="footer-title">Main Categories</h4>
                        <ul class="categories">
                ...
                <div class="col-md-3 col-sm-3">
                    <!-- begin section-container -->
                    <div class="section-container">
                        <h4 class="footer-title">Academic Open Data Portals</h4>
                        <ul class="archives">
    ...
    <div id="footer-copyright" class="footer-copyright">
        <!-- begin container -->
        <div class="container">
            <span class="copyright">&copy; <?php echo date('Y')?> DMU ODAP PROJECT</span>
