			    ...
			    <div class="col-md-10">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-3">
                        ...
                        <div class="panel-body">
                            <form action="/editaddkeywordform" method="POST">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type=text" name="name" value="{{$k->name}}" class="form-control" id="exampleInputEmail1"   placeholder="Enter title of the keyword" required/>
                                    </div>
