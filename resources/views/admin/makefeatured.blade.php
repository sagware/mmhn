...
<head>
	<meta charset="utf-8" />
	<title>Make Featured Innovation Story| Materials and Manufacturing in Healthcare Innovation Network</title>
	...
	<!-- begin #page-loader -->
        ...
        <div class="container">
			<div class="row">
						...
						<h1>Make Featured Innovation Story</h1> <br/>
                        ...
                        <div class="panel-body panel-form">
                            <form  action="/addeditfeatured/public_stories" enctype="multipart/form-data" method="POST"class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form">
...
<textarea id="image-tools" name="message" required>{{$n->news_body}}
								...
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="tm">Featured Story Video (It must be Youtube embedding code)<span class="text-danger">*</span></label>
									<div class="col-md-6 col-sm-6">
									<textarea id="image-tools" name="featured" required>{{$n->featured}}
