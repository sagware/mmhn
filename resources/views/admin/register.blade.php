	...
	<div id="page-container" class="fade">
        ...
        <div class="register register-with-news-feed">
            ...
            <div class="right-content">
                ...
                <h3 align="center">
                   Membership Interest Experession Form
                ...
                <div class="register-content">
                    <form action="/register/new" method="POST"  enctype="multipart/form-data" class="margin-bottom-0">
                        ...
                        <div class="row m-b-15">
                            <div class="col-md-12">
                                <input type="text" class="form-control" placeholder="Intitution e.g., University College London" name="institution"   />
                            </div>
                        </div>
                        ...
                        <div class="row m-b-15">
                            <div class="col-md-12">
                                <textarea type="text" name="reason" class="form-control"  maxlength="200" required> </textarea>
                            </div>
                        </div>
                        ...
                        <div class="checkbox m-b-30">
                            <label>
                                <input type="checkbox" required /> By clicking Show Interest Button, you agree to our <a href="/termsandcondition">Terms</a> and that you have read our <a href="/datapolicy">Data Policy</a>, including our <a href="/cookie">Cookie Use</a>.
                            </label>
                        </div>
