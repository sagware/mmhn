...
<head>
	<meta charset="utf-8" />
	<title>Challenge Story Submission Materials and Manufacturing in Healthcare Network</title>
    ...
    <div id="content" class="content">
        ...
        <div class="container">
            ...
            <div class="row row-space-30">
                <!-- begin col-9 -->
				<p><h1>Challenge Submitted</h1></p>
                <div class="col-md-12">
                    <!-- begin section-container -->
                    <div class="section-container">
                        
                      
              Your challenge has been successfully submitted for review. You will receive an email once it is approved.  <button  ><a href="/clinical_need_form" title="Challenges">Submit Another Challenge</a></button>| <button  ><a href="/clinicalneeds" title="Challenges">Go to Challenges</a></button>
