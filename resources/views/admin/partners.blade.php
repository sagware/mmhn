                            ...
                            <table id="data-table" class="table table-striped table-bordered display" cellspacing="0" width="100%">
								...
								@foreach($gra as $g)
                                    <tr >
										...
										<td>
										@if(in_array($g->id, array(unserialize($p->partners_id))))
										
										@else
										 <a  href="/addpartner/{{$g->id}}">	<button type="button" class="btn btn-primary m-r-5 m-b-5">Add as Partner</button></a>
										 @endif
										</td>
                                    </tr>
									<?php $ct++; ?>
