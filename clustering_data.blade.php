...
<head>
	<meta charset="utf-8" />
	<title>DMU ODAP Metadata List <?php echo date('d/M/Y h:m');?></title>
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">All Meta Data Records</h4>
                        </div>
						
						 <div class="email-btn-row hidden-xs">
					<br/>
					
                        <a href="#t" class="btn btn-sm btn-inverse" ><i class="fa fa-plus m-r-5"></i> Add a Source Portal</a> 
						<a href="#" class="btn btn-sm btn-inverse" ><i class="fa fa-plus m-r-5"></i> Add Dataset</a> 
                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered display" cellspacing="0" width="100%">
								...
								@if(($key % 2 ==0 || $key ==0) && $g->name!=""  && $g->category!="")
                                    <tr >									
									<td>{{$g->name}}</td>
										<td>
										...
										elseif($catarr[$key+1]>=60 && $catarr[$key+1]<80){
										echo 4; 
										}
										elseif($catarr[$key+1]>= 50 && $catarr[$key+1]<60){
										echo 3; 
										}
										elseif($catarr[$key+1]>=40 && $catarr[$key+1]<50){
										echo 2; 
										}
										elseif($catarr[$key+1]<=40){
										echo 1; 
										}
										}
										?>
