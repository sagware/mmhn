...
Route::post('/addeditfeatured/public_stories', 'FormController@addEditFeaturedPublicStories');
...
Route::get('/featuredsubmitted', 'FormController@featuredSubmitted');
...
Route::get('/makefeatured/{id}', 'FormController@showMakeFeatured');
